...
Relational Databases are a type of database that actually holds the data. SQL is the language that is used to interact with the database.
...
An intermediate table with foreign keys as the columns.
